...
#define STRING_CONFIG_H_AUTHOR "(Fxo, BTT SKR 1.4 turbo)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MyPRUSA"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  8.85
    #define DEFAULT_Ki  0.46
    #define DEFAULT_Kd  42.77
  #endif
#else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.4, 80.4, 2724, 930 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 100, 1950000 }
...
//
// Use this option to overriqde the number of step signals required to
